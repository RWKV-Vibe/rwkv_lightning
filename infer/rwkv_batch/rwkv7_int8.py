...
def RWKV_x070_TMix_seq_batch(layer_id: int, H:int, N:int, x, x_prev, v_first, state, x_r, x_w, x_k, x_v, x_a, x_g, w0, w1, w2, a0, a1, a2, v0, v1, v2, g1, g2, k_k, k_a, r_k,
    ...
    if T == 1:
        ...
        return linear_i8(xx * g, O_q, O_mx, O_rx, O_my, O_ry).unsqueeze(1), v_first
...
@MyStatic
def RWKV_x070_TMix_seq_batch_paged(layer_id: int, H:int, N:int, x, x_prev, v_first, state_pool, page_table, x_r, x_w, x_k, x_v, x_a, x_g, w0, w1, w2, a0, a1, a2, v0, v1, v2, g1, g2, k_k, k_a, r_k,
                             R_q, R_mx, R_rx, R_my, R_ry, K_q, K_mx, K_rx, K_my, K_ry, V_q, V_mx, V_rx, V_my, V_ry, O_q, O_mx, O_rx, O_my, O_ry,
                             ln_w, ln_b, elapsed_t):
    B,T,C = x.shape
    if T == 1:
...
def RWKV_x070_CMix_one(x, x_prev, x_k, K_q, K_mx, K_rx, K_my, K_ry, V_):
    ...
    k = torch.relu(linear_i8(k, K_q, K_mx, K_rx, K_my, K_ry)).square_()
